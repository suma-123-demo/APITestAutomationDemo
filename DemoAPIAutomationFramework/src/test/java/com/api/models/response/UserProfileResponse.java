...
public class UserProfileResponse {
	...
	public UserProfileResponse(int id, String username, String password, String email, String firstName,
	...
	public String toString() {
		return "UserProfileResponse [id=" + id + ", username=" + username + ", password=" + password + ", email="
				+ email + ", firstName=" + firstName + ", lastName=" + lastName + ", mobileNumber=" + mobileNumber
				+ ", roles=" + roles + ", active=" + active + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt
